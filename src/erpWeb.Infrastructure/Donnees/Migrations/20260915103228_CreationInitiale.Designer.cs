...
namespace erpWeb.Infrastructure.Donnees.Migrations
{
    ...
    [Migration("20260915103228_CreationInitiale")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("erpWeb.Core.Audit.EntreeJournalAudit", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("TypeEntite", "IdEntite");

                    b.ToTable("JournalAudit", (string)null);
                });

            modelBuilder.Entity("erpWeb.Core.Documents.Document", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("erpWeb.Core.Parametres.Parametre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("erpWeb.Core.Utilisateurs.Utilisateur", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("erpWeb.Core.Utilisateurs.Utilisateur", null)
                        .WithMany()
